...
tape('GunService - insert a reply', async t => {
    ...
    t.deepEqual(
        ...
        [
            {
                messageId:
                    '0xreplyuser/d8064c6026b7f01bf3a8162a63ea2f4f1d7aaa8d935c35cd60913f8950a8cfa3',
...
tape('GunService - insert a moderation', async t => {
    ...
    t.deepEqual(
        ...
        [
            {
                messageId:
                    '0xmockuser/edaeea596a25b2df34f24a6b8d5a746957e8e0f5c184c924cc52a606852effa7',
...
tape('GunService - insert a connection', async t => {
    ...
    t.deepEqual(
        ...
        [
            {
                messageId:
                    '0xmockuser/82d5f06010f32aadfc8953c0491b726ae14c3e0d9690bd736ee0c31bdc9ddae1',
...
tape('GunService - insert a profile', async t => {
    ...
    t.deepEqual(
        ...
        [
            {
                messageId:
                    '0xmockuser/c5308a456cc7ac29d050bcb5f25230b0bcf537a76969aa69d25b4889e50eb751',
