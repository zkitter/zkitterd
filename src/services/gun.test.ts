...
tape('GunService - insert an anon post', async t => {
    ...
    t.deepEqual(
        stubs.threads.addThreadData.args[0],
        ['334bf9fd2507878e566bd7805c46aab513a4e42cc5d1fb8e66f57e8864f50003', '334bf9fd2507878e566bd7805c46aab513a4e42cc5d1fb8e66f57e8864f50003' ],
        'should add thread data',
    );
