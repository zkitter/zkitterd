...
export const semaphoreABI = [
  ...
  { inputs: [], name: 'Semaphore__GroupIdIsNotLessThanSnarkScalarField', type: 'error' },
  ...
  { inputs: [], name: 'Semaphore__YouAreUsingTheSameNillifierTwice', type: 'error' },
  {
    anonymous: false,
    inputs: [
  ...
  },
  {
    ...
    inputs: [
      ...
      { indexed: false, internalType: 'uint256', name: 'zeroValue', type: 'uint256' },
    ],
    name: 'GroupCreated',
    type: 'event',
  },
  ...
  {
    anonymous: false,
    inputs: [{ indexed: false, internalType: 'uint256', name: 'nullifierHash', type: 'uint256' }],
  ...
  },
  {
    inputs: [
      ...
      { internalType: 'uint256', name: 'zeroValue', type: 'uint256' },
      { internalType: 'address', name: 'admin', type: 'address' },
      { internalType: 'uint256', name: 'merkleTreeRootDuration', type: 'uint256' },
    ],
    name: 'createGroup',
    outputs: [],
    stateMutability: 'nonpayable',
  ...
  },
  {
    ...
    outputs: [
      { internalType: 'address', name: 'admin', type: 'address' },
      { internalType: 'uint256', name: 'merkleRootDuration', type: 'uint256' },
    ],
    stateMutability: 'view',
    type: 'function',
  },
